...
DATA_DIR = Path("w8d3_data")
EVIDENCE_DIR = Path("output_evidence/w8d3")
...
def build_evidence(
    ...
    lines.append("=" * 70)
    lines.append("W8D3: HAYSTACK RETRIEVAL — BM25 & DENSE RETRIEVAL")
    lines.append("=" * 70)
    lines.append("")
...
def main():
    print("=" * 70)
    print("W8D3: HAYSTACK RETRIEVAL — BM25 & DENSE RETRIEVAL")
    print("=" * 70)
    ...
    print("W8D3 retrieval evaluation completed.")
